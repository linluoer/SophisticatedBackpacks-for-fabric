...
public class GuiHelper {
	...
	public static final TextureBlitData SMALL_BUTTON_HOVERED_BACKGROUND = new TextureBlitData(GUI_CONTROLS, Dimension.SQUARE_256, new UV(41, 18),
			Dimension.SQUARE_12);
	...
	public static void renderItemInGUI(GuiGraphicsExtractor guiGraphics, Minecraft minecraft, ItemStack stack, int xPosition, int yPosition,
			boolean renderOverlay, @Nullable String countText) {
	...
	public static void blit(GuiGraphicsExtractor guiGraphics, int x, int y, TextureBlitData texData) {
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, texData.getTextureName(), x + texData.getXOffset(), y + texData.getYOffset(), texData.getU(),
				texData.getV(), texData.getWidth(), texData.getHeight(), texData.getTextureWidth(), texData.getTextureHeight());
	}
	...
	public static void blit(GuiGraphicsExtractor guiGraphics, int x, int y, TextureBlitData texData, int width, int height) {
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, texData.getTextureName(), x + texData.getXOffset(), y + texData.getYOffset(), texData.getU(),
				texData.getV(), halfWidth, halfHeight, texData.getTextureWidth(), texData.getTextureHeight());
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, texData.getTextureName(), x + texData.getXOffset() + halfWidth, y + texData.getYOffset(),
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, texData.getTextureName(), x + texData.getXOffset(), y + texData.getYOffset() + halfHeight,
				texData.getU(), (float) texData.getV() + texData.getHeight() - secondHalfHeight, halfWidth, secondHalfHeight, texData.getTextureWidth(),
				texData.getTextureHeight());
	...
	public static void coloredBlit(GuiGraphicsExtractor guiGraphics, int x, int y, TextureBlitData texData, int color) {
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, texData.getTextureName(), xMin, yMin, texData.getU(), texData.getV(), texData.getWidth(),
				texData.getHeight(), texData.getTextureWidth(), texData.getTextureHeight(), color);
	}
	...
	public static void renderTiledSprite(GuiGraphicsExtractor guiGraphics, TextureAtlasSprite sprite, int color, int x, int y, int height) {
		...
		do {
			...
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, sprite.atlasLocation(), x, startY, textureWidth * sprite.getU0(), textureHeight * sprite.getV0(), 16,
					renderHeight, textureWidth, textureHeight, color);
	...
	public static void renderControlBackground(GuiGraphicsExtractor guiGraphics, int x, int y, int renderWidth, int renderHeight, int u, int v,
			int textureBgWidth, int textureBgHeight) {
		int halfWidth = renderWidth / 2;
		int halfHeight = renderHeight / 2;
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x, y, u, v, halfWidth, halfHeight, GUI_CONTROLS_TEXTURE_WIDTH,
				GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x, y + halfHeight, u, (float) v + textureBgHeight - halfHeight, halfWidth, halfHeight,
				GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x + halfWidth, y, (float) u + textureBgWidth - halfWidth, v, halfWidth, halfHeight,
				GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x + halfWidth, y + halfHeight, (float) u + textureBgWidth - halfWidth,
	...
	public static void renderTabBackground(GuiGraphicsExtractor guiGraphics, int x, int y, int width, int height) {
		...
		if (width <= GUI_CONTROLS_TEXTURE_WIDTH / 2) {
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x, y, (float) GUI_CONTROLS_TEXTURE_WIDTH - width, 0, width, halfHeight,
					GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x, y + halfHeight, (float) GUI_CONTROLS_TEXTURE_WIDTH - width,
			...
			guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x - 3, y, GUI_CONTROLS_TEXTURE_WIDTH / 2, GUI_CONTROLS_TEXTURE_HEIGHT - height, 3,
					height, GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
			return;
		}
	...
	public static void renderTiledControlBackground(GuiGraphicsExtractor guiGraphics, int x, int y, int width, int height, int u, int v, int textureWidth,
			int textureHeight) {
	...
	public static void renderTiledControlBackground(GuiGraphicsExtractor guiGraphics, int x, int y, int width, int height, int u, int v, int textureWidth,
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x, y, (float) u, (float) v, leftWidth, topHeight, GUI_CONTROLS_TEXTURE_WIDTH,
				GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x + leftWidth + centerWidth, y, (float) sourceRightU, (float) v, rightWidth, topHeight,
				GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x, y + topHeight + centerHeight, (float) u, (float) sourceBottomV, leftWidth, bottomHeight,
				GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x + leftWidth + centerWidth, y + topHeight + centerHeight, (float) sourceRightU,
				(float) sourceBottomV, rightWidth, bottomHeight, GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
	...
	private static void renderTiledTexture(GuiGraphicsExtractor guiGraphics, int x, int y, int width, int height, int u, int v, int textureWidth,
			int textureHeight) {
		...
		while (renderedY < height) {
			...
			while (renderedX < width) {
				...
				guiGraphics.blit(RenderPipelines.GUI_TEXTURED, GUI_CONTROLS, x + renderedX, y + renderedY, (float) u, (float) v, chunkWidth, chunkHeight,
						GUI_CONTROLS_TEXTURE_WIDTH, GUI_CONTROLS_TEXTURE_HEIGHT);
