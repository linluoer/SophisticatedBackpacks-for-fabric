...
public class ModPayloads {
	...
	public static void registerPayloads(final RegisterPayloadHandlersEvent event) {
		...
		registrar.playToClient(OpenMenuDataPayload.TYPE, OpenMenuDataPayload.STREAM_CODEC, OpenMenuDataPayload::handlePayload);
		registrar.playToClient(SyncRecipesPayload.TYPE, SyncRecipesPayload.STREAM_CODEC, SyncRecipesPayload::handlePayload);
	}
}
