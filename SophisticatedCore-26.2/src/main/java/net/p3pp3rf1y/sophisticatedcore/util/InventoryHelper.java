...
public class InventoryHelper {
	...
	static {
		registerPlayerInventoryProvider(player -> PlayerInventoryWrapper.of(player).getMainInventory());
	...
	public static int move(ResourceHandler<ItemResource> from, ResourceHandler<ItemResource> to, Predicate<ItemResource> filter, int maxAmount,
			Transaction tx) {
		return ResourceHandlerUtil.moveAll(from, to, filter, maxAmount, tx);
	}
