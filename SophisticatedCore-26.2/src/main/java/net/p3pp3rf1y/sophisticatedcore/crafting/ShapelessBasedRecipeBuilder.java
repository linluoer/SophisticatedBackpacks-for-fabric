...
public class ShapelessBasedRecipeBuilder implements RecipeBuilder {
	...
	public ShapelessBasedRecipeBuilder(HolderGetter<Item> items, ItemLike result, ItemStackTemplate resultTemplate,
	...
	public void save(RecipeOutput recipeOutput, ResourceKey<Recipe<?>> id) {
		...
		recipeOutput.accept(id, factory.apply(compose), holdingRecipeOutput.getAdvancementHolder());
	}
}
