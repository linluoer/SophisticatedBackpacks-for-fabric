...
public class BatteryUpgradeTab extends UpgradeSettingsTab<BatteryUpgradeContainer> {
	...
	protected void moveSlotsToTab() {
		...
		positionSlot(slots.get(BatteryUpgradeWrapper.INPUT_SLOT), screen.leftPos, screen.topPos, 4);
		positionSlot(slots.get(BatteryUpgradeWrapper.OUTPUT_SLOT), screen.leftPos, screen.topPos, 25);
	}
