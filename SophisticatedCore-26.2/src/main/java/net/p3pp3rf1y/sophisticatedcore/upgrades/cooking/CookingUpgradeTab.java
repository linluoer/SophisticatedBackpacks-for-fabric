...
public abstract class CookingUpgradeTab<R extends AbstractCookingRecipe, W extends CookingUpgradeWrapper<W, ?, R>>
		extends
			UpgradeSettingsTab<CookingUpgradeContainer<R, W>> {
	private final CookingLogicControl<R> cookingLogicControl;

	protected CookingUpgradeTab(CookingUpgradeContainer<R, W> upgradeContainer, Position position, StorageScreenBase<?> screen, String tabLabel,
	...
	protected void moveSlotsToTab() {
		cookingLogicControl.moveSlotsToView(screen.leftPos, screen.topPos);
	}
	...
	public static class SmeltingUpgradeTab extends CookingUpgradeTab<SmeltingRecipe, CookingUpgradeWrapper.SmeltingUpgradeWrapper> {
		public SmeltingUpgradeTab(CookingUpgradeContainer<SmeltingRecipe, CookingUpgradeWrapper.SmeltingUpgradeWrapper> upgradeContainer, Position position,
	...
	public static class SmokingUpgradeTab extends CookingUpgradeTab<SmokingRecipe, CookingUpgradeWrapper.SmokingUpgradeWrapper> {
		public SmokingUpgradeTab(CookingUpgradeContainer<SmokingRecipe, CookingUpgradeWrapper.SmokingUpgradeWrapper> upgradeContainer, Position position,
				StorageScreenBase<?> screen) {
	...
	public static class BlastingUpgradeTab extends CookingUpgradeTab<BlastingRecipe, CookingUpgradeWrapper.BlastingUpgradeWrapper> {
		public BlastingUpgradeTab(CookingUpgradeContainer<BlastingRecipe, CookingUpgradeWrapper.BlastingUpgradeWrapper> upgradeContainer, Position position,
				StorageScreenBase<?> screen) {
