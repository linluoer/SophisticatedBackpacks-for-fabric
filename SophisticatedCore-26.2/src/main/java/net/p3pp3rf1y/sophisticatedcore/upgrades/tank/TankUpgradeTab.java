...
public class TankUpgradeTab extends UpgradeSettingsTab<TankUpgradeContainer> {
	...
	protected void moveSlotsToTab() {
		...
		positionSlot(slots.get(TankUpgradeWrapper.INPUT_SLOT), screen.leftPos, screen.topPos, 4, 0);
		positionSlot(slots.get(TankUpgradeWrapper.OUTPUT_SLOT), screen.leftPos, screen.topPos, 25, 0);
		positionSlot(slots.get(TankUpgradeWrapper.INPUT_RESULT_SLOT), screen.leftPos, screen.topPos, 4, 32);
		positionSlot(slots.get(TankUpgradeWrapper.OUTPUT_RESULT_SLOT), screen.leftPos, screen.topPos, 25, 32);
	}
